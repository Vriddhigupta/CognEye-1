...
4. **Sanika Gadge:** "Overall this was a very great experience. I along with my team-mate Atharva maily focused on the object detection feature for the application. We integrated a pre-trained Tensorflow object detection model to our UI. Along with that implementing text to speech in Android to convert the labels into voice notes. I learnt alot of new things like getting a small intoduction to android studio. Working on the website was also a great learning experience along with Jayvanti and Atharva. I'll like to thank SkillUp for providing us with this opportunity and opening new areas of learning."
5. **Purva Anjarlekar:** "I had just started learning ML when I joined this group project. It helped me a lot with implementation and understanding concepts. We specifically didn't work on developing a model but learning to work with APIs and integrating it with the app was very interesting to do. Thank you for this opportunity provided by SkillUp compelling me to study the subject."
## Future scope
